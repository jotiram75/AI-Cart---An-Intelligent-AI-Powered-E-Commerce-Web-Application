...
function Cart() {
    ...
    return (
        <div className='border-t border-gray-200 pt-32 container mx-auto px-4 min-h-screen bg-white'>
        ...
        <>
          ...
          <div className='flex justify-end my-20'>
            <div className='w-full sm:w-[450px]'>
              {/* <CartTotal /> removed as per request */}
        ...
        <div className="flex flex-col items-center justify-center py-20">
          <div className="text-center">
            ...
            <button 
              ...
              className="px-8 py-3 bg-primary text-white font-bold rounded-full shadow hover:shadow-lg transition-all hover:bg-gray-800"
            >
              CONTINUE SHOPPING
            </button>
          </div>
