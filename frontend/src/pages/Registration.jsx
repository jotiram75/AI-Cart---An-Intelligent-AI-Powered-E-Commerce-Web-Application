...
import { IoEyeOutline, IoEye, IoPersonOutline, IoMailOutline, IoLockClosedOutline } from "react-icons/io5";
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-2">Join AICart to start shopping</p>
          </div>
