        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="order-1 lg:order-2 space-y-6 text-gray-600">
            <p className="text-base md:text-lg leading-relaxed">
              AICART was born for smart, seamless shopping—created to deliver
              quality products, trending styles, and everyday essentials in one
              place. With reliable service, fast delivery, and great value,
              AICart makes your online shopping experience simple, satisfying,
              and stress-free.
            </p>
            <p className="text-base md:text-lg leading-relaxed">
              Data-driven and customer-focused, we bridge the gap between modern
              shoppers and the products they love. Whether it's fashion,
            ...
            <div className="pt-4">
              ...
              <p className="text-base md:text-lg leading-relaxed">
                ...
                quality, affordability, and convenience. AICart connects
                customers with trusted products and brands, offering a seamless,
                customer-focused experience that saves time, adds value, and
                fits every lifestyle and need.
              </p>
            </div>
          </div>
        </div>
